...
<div class="titre">MODIFIER artiste</div>
    ...
    <article>
        ...
        <span class='champs'><strong>Tags :</strong><br /><input type="text" name="tag" value="<?php foreach ($tag as $val) {if(!empty($val))echo $val.',';}  ?>" /><br>Ne pas encore utiliser. Merci.</span>
